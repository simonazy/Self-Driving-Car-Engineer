...
class VehicleDetection():
    def __init__(self, clf_final, scaler, lq=25, thre=10, ystart=400, ystop=656, 
        scale=1.5, orient=9, pix_per_cell=8, cell_per_block=2, 
    ...
    def pipeline(self, img, final_lane):
        ...
        rst = get_box_img(final_lane, self.queue, self.thre)
        return rst